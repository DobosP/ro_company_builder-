...
- **Arbitrage detail (buy-day/sell-night):** DAM goes **negative midday** and peaks **~€198/MWh evening** [E48](sources.md#e48); charge midday, discharge evening/morning. **July 2025: ANRE ended BESS double taxation** (stored→reinjected exempt from transmission/distribution/system fees) — the key enabler. Pure arbitrage is thin (~5–7% IRR); **stack it with balancing**. See [arbitrage-strategy.md](../arbitrage-strategy.md). [E49](sources.md#e49) [E50](sources.md#e50)
